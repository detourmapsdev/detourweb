...
from community.tweepy.binder import bind_api
from community.tweepy.error import TweepError
from community.tweepy.parsers import ModelParser
from community.tweepy.utils import list_to_csv
...
class API(object):
    ...
    search = bind_api(
        ...
        allowed_param=['q', 'lang', 'locale', 'rpp', 'page', 'since_id', 'geocode', 'show_user', 'max_id', 'since',
                       'until', 'result_type']
    )
